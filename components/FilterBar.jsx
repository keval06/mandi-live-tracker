...
export default function FilterBar({ states = [], activeState, activeCategory, activeRange }) {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-lg px-4 py-2.5 text-xs mb-3 space-y-2">

      {/* Row 1 — Category pills (scrolls horizontally on mobile) */}
      ...
      {/* Row 2 — State + Period (wraps naturally) */}
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="w-px h-4 bg-gray-200 mx-1 shrink-0 hidden sm:block" />
